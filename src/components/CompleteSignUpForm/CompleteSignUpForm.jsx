...
const CompleteSignUpForm = () => {
      ...
      case "phoneNumber":
        if (valueInput === "")
          ...
          setError({
            ...error,
            phoneNumber:
              "El número telefónico debe contener por lo menos 8 números",
          });
  ...
  async function handleSubmit(evento) {
    //funcion llamada por onsubmit para despachar la accion registerUser
    evento.preventDefault();

    dispatch(
      completeSignUp(loggedUser.id, {
        cityId: input.city,
